...
public class one_difficult_canvas extends View { //you have to create a new java file and then insert the same file in the xml of the page in which you want the canvas
    ...
    public one_difficult_canvas(Context context, AttributeSet attrs) {
        super(context, attrs);
