...
public class two_player_single_canvas extends View { //you have to create a new java file and then insert the same file in the xml of the page in which you want the canvas
    ...
    public two_player_single_canvas(Context context, AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
